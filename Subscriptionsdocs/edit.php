...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $subscriptionsdoc->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $subscriptionsdoc->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="subscriptionsdocs form content">
            ...
            <fieldset>
                <legend><?= __('Edit Subscriptionsdoc') ?></legend>
                <?php
