        ...
        <div class="col-4">
            ...
            <ul class="list-group list-group-flush">
              <?php foreach ($roleventlist as $key => $roleventDescription): ?>
                	<li class="list-group-item"><a href = <?= $this->Url->build(['controller'=>'Rolevents','action'=>'viewfree', $key]) ?>><?= $roleventDescription ?></li>
              <?php endforeach; ?>              
            </ul>
        ...
        <div class="col-8">
            <div class="row">
               <div class="list-group ">
                  ...
                  <a href="<?= $this->Url->build(['controller'=>'Rolevents','action'=>'viewfree', $breakingnew->rolevent_id]) ?>" class="list-group-item list-group-item-action flex-column mb-2">
                    <div class="d-flex w-100 justify-content-between">
                      <h4 class="display-5"><?= $breakingnew->description ?></h4>                      
