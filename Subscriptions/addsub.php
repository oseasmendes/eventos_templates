...
<div class="row">
    ...
    <div class="column-responsive column-80">
        <div class="subscriptions form content">
            ...
            <?php $paramid = $_POST['SubsGene']; ?>            
            <?php $this->people_id = (int)$paramid; ?>
            ...
            <fieldset>
                ...
                <?php
                   // echo $this->cell('Roleventimage::getimagename', [$this->rolevent_id,'icon']);  
                    ...
                    echo $this->Form->control('dateissue', array('label'=>'Data Emissão: ','value'=>$hoje,'empty' => true));
                    //'disabled'=>'disabled'
                    ...
                    echo  $this->Form->input('people_id', array(
                            'type' => 'select',
                            'options' => $peoples, 
                            'label' => 'Evento',
                            'value' => $paramid,  // default value
                            ...
                            echo $this->Form->control('controlnumber',['label'=>'Numero Inscrição Referenciada']);
                            echo $this->Form->control('paymentvalue',['label'=>'Valor']);
