...
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?= $this->Url->build('/', ['fullBase'=>true]) ?>" class="brand-link">

    <?= 
      $this->Html->image("logoadbelem.png",[
                      "alt"=>"ADB Logo",
    ...
    ?>
      ...
      <span class="brand-text font-weight-light">SaesChurch</span>
    </a>
        ...
        <div class="image">
            ...
            <?= 
             /* $this->Html->image("/dist/img/user2-160x160.jpg",[
              ...
              $this->Html->image("saeschurch.png",[
                              "alt"=>"User Image",
                              "class"=>"img-circle elevation-2",                             
              ])
            ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item">
                <a href="<?= $this->Url->build('/eventos', ["fullBase" => true]) ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Catálogo de Eventos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= $this->Url->build('/noticias', ["fullBase" => true]) ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Catálogo de Notícias</p>
                </a>
              </li>
             
              <li class="nav-item">
                <a href="<?= $this->Url->build('/', ["fullBase" => true]) ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">                       
            <a href="<?= $this->Url->build('/logout', ["fullBase" => true]) ?>" class="nav-link">            
