                ...
                <div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <?php if ($roleid == 1 ) : ?>
                                <?= $this->Html->link(__('Editar Evento'), ['action' => 'edit', $rolevent->id], ['class'=>'dropdown-item']) ?>
                                <?= $this->Form->postLink(__('Deletar Evento'), ['action' => 'delete', $rolevent->id], ['confirm' => __('Are you sure you want to delete # {0}?', $rolevent->id), 'class'=>'dropdown-item']) ?>            
                                <?= $this->Html->link(__('Novo Evento'), ['action' => 'add'], ['class'=>'dropdown-item']) ?>
                                <?php endif; ?>
                                <?= $this->Html->link(__('Dados do Usuário'), ['controller' => 'Users', 'action' => 'view', $userid], ['class'=>'dropdown-item']) ?>             
                                <?= $this->Html->link(__('Eventos Em Andamento'), ['action' => 'index'], ['class'=>'dropdown-item']) ?>
        ...
        <div class="rolevents view content">
            ...
            <div class="container">            
                <div class="row">
                                ...
                                ?>
                                <?php 
                                if (empty($rolevent->subscriptions) && ($rolevent->subscriptionrequired == TRUE) && ($roleid != 1) ) : ?> 
                                    <div class="col-3"> 
